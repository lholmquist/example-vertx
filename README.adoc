...
----
$ git clone git@github.com:lholmquist/example-vertx
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/lholmquist/example-vertx/edit/master/{fileLocation}[`{fileLocation}`]).
